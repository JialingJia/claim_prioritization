...
with st.sidebar:
    ...
    verifiable_weight_slider = st.slider('Verifiable', key='verifiable_weight', min_value=0.0, value=0.1, max_value=1.0, format="%f", label_visibility='collapsed')
    ...
    false_info_weight_slider = st.slider('false_info', key='false_info_weight', min_value=0.0, value=0.1, max_value=1.0, format="%f", label_visibility='collapsed')
    ...
    interest_to_public_weight_slider = st.slider('interest_to_public', key='interest_to_public_weight', min_value=0.0, value=0.1, max_value=1.0, format="%f", label_visibility='collapsed')
    ...
    general_harm_weight_slider = st.slider('general_harm', key='general_harm_weight', min_value=0.0, value=0.1, max_value=1.0, format="%f", label_visibility='collapsed')
    ...
    attention_to_fact_check_weight_slider = st.slider('attention_to_fact_check', key='attention_to_fact_check_weight', min_value=0.0, value=0.1, max_value=1.0, format="%f", label_visibility='collapsed')
    ...
    if st.session_state['user_defined_facet']:
        for item in st.session_state['user_defined_facet']:
            ...
            new_facet_weight_slider = st.slider('new_facet_weight_slider', key=new_facet + '_weight_slider', min_value=0.0, value=0.1, max_value=1.0, format="%f", label_visibility='collapsed')
